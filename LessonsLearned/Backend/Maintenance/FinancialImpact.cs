...
{
    public class FinancialImpact : LLBusinessObjectBase
    {
        public FinancialImpact()
        {
            m_dataTableName = "LL_FINANCIAL_IMPACT";
        }
    
		private object	m_id 	            = System.DBNull.Value;
        ...
        protected IDbCommand SelectActiveCommand
        {
            get
            {
                ...
                cmd = DBConnection.CreateCommand();
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "ll_financial_impact_pkg.GET_financial_impact";
                return cmd;
            }
        }
