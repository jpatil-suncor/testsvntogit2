...
{
    public class Frequency : LLBusinessObjectBase
    {
        public Frequency()
        {
            m_dataTableName = "LL_OCCURRENCE_FREQUENCY";
        }
        ...
        protected IDbCommand SelectActiveCommand
        {
            get
            {
                ...
                cmd = DBConnection.CreateCommand();
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "LL_OCCURRENCE_FREQUENCY_PKG.GET_OCCURRENCE_FREQUENCY";
                return cmd;
            }
        }
